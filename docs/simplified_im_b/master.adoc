...
= openEHR Simplified Information Model 'B' (SIM-B)
...
include::master03-simplified_im.adoc[leveloffset=+1]
include::master04-app_context.adoc[leveloffset=+1]
include::master05-transformation_rules.adoc[leveloffset=+1]
