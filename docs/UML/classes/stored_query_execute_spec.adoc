...
h|*1..1*
|*query_parameters*: `link:/releases/BASE/{sm_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^], link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]>`
