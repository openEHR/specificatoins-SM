...
|*get_ehr_status* ( +
an_ehr_id: `link:/releases/BASE/{sm_release}/base_types.html#_uuid_class[UUID^][1]` +
): `link:/releases/RM/{sm_release}/ehr.html#_ehr_status_class[EHR_STATUS^]` +
 +
__Pre_has_ehr__: `has_ehr (an_ehr_id)`
...
an_ehr_id: `link:/releases/BASE/{sm_release}/base_types.html#_uuid_class[UUID^][1]`, +
a_details: `link:/releases/RM/{sm_release}/data_structures.html#_item_tree_class[ITEM_TREE^][1]` +
) +
 +
__Pre_has_ehr__: `has_ehr (an_ehr_id)`
...
an_ehr_id: `link:/releases/BASE/{sm_release}/base_types.html#_uuid_class[UUID^][1]` +
): `link:/releases/RM/{sm_release}/ehr.html#_versioned_ehr_status_class[VERSIONED_EHR_STATUS^]` +
 +
__Pre_has_ehr__: `has_ehr (an_ehr_id)` +
