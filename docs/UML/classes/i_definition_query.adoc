...
h|*1..1*
|*has_query* ( +
a_query_name: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][1]` +
...
h|*1..1*
|*valid_query* ( +
a_query_text: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][1]`, +
a_formalism: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][1]` +
): `link:/releases/BASE/{sm_release}/foundation_types.html#_boolean_class[Boolean^]`
...
a_query_text: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][1]`, +
a_formalism: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][1]`, +
a_query_name: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][0..1]` +
...
h|*1..1*
|*register_query_set* ( +
a_query_set_name: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][0..1]` +
...
): `link:/releases/BASE/{sm_release}/foundation_types.html#_list_class[List^]<<<_query_descriptor_class,QUERY_DESCRIPTOR>>>`
...
artefact_id_pattern: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^][1]`, +
item_offset: `link:/releases/BASE/{sm_release}/foundation_types.html#_integer_class[Integer^][0..1]`, +
items_to_fetch: `link:/releases/BASE/{sm_release}/foundation_types.html#_integer_class[Integer^][0..1]` +
): `link:/releases/BASE/{sm_release}/foundation_types.html#_list_class[List^]<<<_query_descriptor_class,QUERY_DESCRIPTOR>>>`
...
h|*1..1*
|*queries_count* (): `link:/releases/BASE/{sm_release}/foundation_types.html#_integer_class[Integer^]`
