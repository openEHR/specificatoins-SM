...
h|*1..1*
|*columns*: `link:/releases/BASE/{sm_release}/foundation_types.html#_list_class[List^]<<<_result_set_column_class,RESULT_SET_COLUMN>>>`
a|Column definition structure.

h|*1..1*
|*id*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
a|Unique identifier of this result set.

h|*1..1*
|*creation_time*: `link:/releases/BASE/{sm_release}/foundation_types.html#_iso8601_date_time_class[Iso8601_date_time^]`
...
h|*0..1*
|*rows*: `link:/releases/BASE/{sm_release}/foundation_types.html#_list_class[List^]<<<_result_set_row_class,RESULT_SET_ROW>>>`
a|Rox data.
|===
