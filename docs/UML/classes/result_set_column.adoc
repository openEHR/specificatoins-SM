...
h|*1..1*
|*name*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*path*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
