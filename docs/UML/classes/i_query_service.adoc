...
row_offset: `link:/releases/BASE/{sm_release}/foundation_types.html#_integer_class[Integer^][0..1]`, +
rows_to_fetch: `link:/releases/BASE/{sm_release}/foundation_types.html#_integer_class[Integer^][0..1]`, +
