...
): `link:/releases/RM/{sm_release}/data_types.html#_data_value_class[DATA_VALUE^]`
a|

h|*0..1 +
(effected)*
|*from_rm* ( +
a_val: `link:/releases/RM/{sm_release}/data_types.html#_data_value_class[DATA_VALUE^][1]` +
)
a|
|===
