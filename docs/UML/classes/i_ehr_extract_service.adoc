...
): `link:/releases/BASE/{sm_release}/foundation_types.html#_list_class[List^]<link:/releases/RM/{sm_release}/ehr_extract.html#_extract_class[EXTRACT^]>`
a|Export whole EHR for one or more subjects.

h|*0..1*
|*export_ehr_extracts* ( +
extract_spec: `link:/releases/RM/{sm_release}/ehr_extract.html#_extract_spec_class[EXTRACT_SPEC^][1]` +
): `link:/releases/BASE/{sm_release}/foundation_types.html#_list_class[List^]<link:/releases/RM/{sm_release}/ehr_extract.html#_extract_class[EXTRACT^]>`
a|Export an extract for one or more EHRs.

h|*0..1*
|*import_ehr* ( +
an_ehr_id: `link:/releases/BASE/{sm_release}/base_types.html#_uuid_class[UUID^][0..1]`, +
an_extract: `link:/releases/RM/{sm_release}/ehr_extract.html#_extract_class[EXTRACT^][1]` +
)
