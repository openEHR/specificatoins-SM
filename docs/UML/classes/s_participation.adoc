...
h|*0..1*
|*mode*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
a|Converted from `PARTICIPATION._mode_: DV_CODED_TEXT`.

h|*1..1*
|*function*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
