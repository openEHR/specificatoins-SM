...
h|*1..1*
|*qualified_query_name*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
a|Unique qualified name of query. Qualified names follow patterns such as `<namespace>::<query_name>`

e.g. "ehr::all_over_50_women".

h|*0..1*
|*version*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
a|Query semver.org version number.

h|*1..1*
|*registration_time*: `link:/releases/BASE/{sm_release}/foundation_types.html#_iso8601_date_time_class[Iso8601_date_time^]`
a|Time query was registered in the service.

h|*1..1*
|*formalism*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*source*: `link:/releases/BASE/{sm_release}/foundation_types.html#_string_class[String^]`
