...
[.text-center]
.`sm.openehr_platform.platform_interface.query` package
image::{uml_export_dir}/diagrams/SM-platform_interface.query.svg[id=platform_interface_query, align="center"]
